  ...
  return (
    <div className={`mt-3 ${isDebug ? "debug-border" : ""}`}>
      ...
      <div className="flex items-center gap-2 mt-2">
        ...
        {hasChanged ? (
          <button
            className="flex items-center justify-center text-sm px-4 py-2.5 rounded-md text-white"
          ...
          <button
            className="flex items-center justify-center text-sm px-4 py-2.5 rounded-md border border-gray-300 bg-white"
